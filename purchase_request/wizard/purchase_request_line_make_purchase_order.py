...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    def _check_valid_request_line(self, request_line_ids):
        ...
        for line in self.env['purchase.request.line'].browse(request_line_ids):
            ...
            if line.request_id.state != 'approved':
                raise UserError(
                    _('Purchase Request {0} is not approved').format(line.request_id.name))
    ...
    def _prepare_purchase_order_line(self, po, item):
        ...
        vals = {
            ...
            'date_planned': datetime.datetime.combine(item.line_id.date_required, datetime.time.min),
    ...
    def make_purchase_order(self):
        ...
        for item in self.item_ids:
            ...
            po_line.date_planned =  datetime.datetime.combine(item.line_id.date_required, datetime.time.min)
...
class PurchaseRequestLineMakePurchaseOrderItem(models.TransientModel):
    ...
    keep_description = fields.Boolean(string='Copy descriptions to new PO', default=True,
